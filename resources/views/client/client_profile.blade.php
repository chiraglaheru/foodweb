                ...
                <div class="card-body p-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-3 mt-lg-0">
                            ...
                            <div class="mb-3">
                                <img id="ShowImage" src="{{ (!empty($profileData->photo)) ? url('upload/client_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="" class="rounded-circle p-1 bg-primary" width="100">
                            </div>
                            <div class="mt-4">
